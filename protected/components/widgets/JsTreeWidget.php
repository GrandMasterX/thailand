...
EOD;
        ...
        //Yii::app()->clientScript->registerCssFile($baseUrl . '/js/bootstrap/css/bootstrap.css');
        ...
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/noty/js/noty/jquery.noty.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/noty/js/noty/layouts/center.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/noty/js/noty/themes/default.js', CClientScript::POS_END);
        //js spinner
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/spin.min.js', CClientScript::POS_END);
        //fancybox
       Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/fancybox2/jquery.fancybox.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerCssFile($baseUrl . '/js/fancybox2/jquery.fancybox.css');

        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/json2/json2.js');

        Yii::app()->clientScript->registerCoreScript('yiiactiveform');

        // jquery.form.js plugin http://malsup.com/jquery/form/
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/ajaxform/jquery.form.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/ajaxform/form.js', CClientScript::POS_END);
        //jstree
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/jstree/jquery.jstree.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseUrl . '/js/jstree.behavior.js', CClientScript::POS_END);
    }
