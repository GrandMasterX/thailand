...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'attribute-form',
    'action' => ($model->isNewRecord) ? $this->createUrl('attribute/create') : $this->createUrl('attribute/update', array('id' => $model->id)),
    ...
    <?php echo $form->dropDownListRow($model, 'type', Attribute::getList(),
        array(
			'id' => 'type',
			'class' => 'span5',
			'empty' => 'Выберите тип',
