...
<div id="form-typeAttribute">
    ...
    <?php echo CHtml::dropDownList('attribute_id', 'attribute_id', Attribute::getListData(),
        array(
			'id' => 'attribute_id',
            'class' => 'span5',
			...
			<tbody>
				...
				<tr>
					<td>
                        ...
                        <?php echo CHtml::hiddenField('AttributeGroup[myAttributes][]', $attribute->id) ?>
					</td>
					<td style="width: 80px">
	...
	$(function() {
		$('#list-button').on('click', function() {
			...
			var html = '<tr>' +
							'<td>' +
								option.text +
								'<input type="hidden" name="AttributeGroup[myAttributes][]" value="' + option.value + '">' +
							'</td>' +
							'<td style="width: 80px">' +
								'<a class="delete btn btn-danger btn-small" rel="tooltip" data-original-title="Удалить"><i class="icon-remove icon-white"></i></a>' +
							'</td>' +
