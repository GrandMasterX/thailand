	...
	<table class="shop_table my_account_orders">
		<thead>
			<tr>
                ...
                <th class="order-total"><span class="nobr">Ціна</span></th>
                <th class="order-total"><span class="nobr">Сума</span></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="order">
				...
				<td class="order-total">
					<span class="amount"><?php echo CText::number($product['price']) ?></span> 		
				</td>
				<td class="order-total">
					<span class="amount"><?php echo CText::number($product['quantity'] * $product['price']) ?></span> 		
				</td>
			</tr>
			<?php
...
<ul>
	<li>Всього найменувань <?php echo count($model->productArray) ?>, на суму <?php echo CText::number($model->sum) ?> грн.</li>
