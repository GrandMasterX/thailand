(function($){
    ...
    $.rangeFormula = {
        ...
        processPointers: function(form,minusM,minus,plus,plusM) {
            ...
            $.each(window.sizeListArray, function(indexS, size) {
                ...
                if($.rangeFormula.between('minus',valueByIndex,minusM,minus)) {
                    ...
                    $.rangeFormula.positionPointer(valueByIndex,form,size,'minus',leftPropPix);// was 'minus'+size but I removed +size and only class name is passed
                    ...
                    $.rangeFormula.positionPointer(valueByIndex,form,size,'recomended',leftPropPix);
        ...
        createPointer: function(size,className,value) {
            return '<a id="pointer_'+size+'" href="#" class="f-pointer '+className+'" style="z-index:'+size+'" title="'+value+'"><span class="sizeTitle">'+size+'</span></a>';
        },
        ...
        positionPointer: function(valueByIndex,form,size,className,leftPropPix) {
            var offset = form.find('div.res-formula-holder').offset();
            if(leftPropPix===undefined){
                form
                    .find('.size_wrapper')
                    .prepend($.rangeFormula.createPointer(size,className,valueByIndex))
